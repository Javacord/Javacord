 ...
 */
@FunctionalInterface
public interface ApplicationCommandCreateListener extends ServerAttachableListener, UserAttachableListener,
     ...
     */
    void onSlashCommandCreate(ApplicationCommandCreateEvent event);
}
