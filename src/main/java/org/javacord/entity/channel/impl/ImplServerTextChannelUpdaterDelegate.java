 ...
 */
public class ImplServerTextChannelUpdaterDelegate extends ImplServerChannelUpdaterDelegate
     ...
     */
    public ImplServerTextChannelUpdaterDelegate(ServerTextChannel channel) {
        super(channel);
    }
