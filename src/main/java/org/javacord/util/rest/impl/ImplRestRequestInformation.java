 ...
 */
public class ImplRestRequestInformation implements RestRequestInformation {
     ...
     */
    public ImplRestRequestInformation(DiscordApi api, URL url, Map<String, String> queryParameter,
