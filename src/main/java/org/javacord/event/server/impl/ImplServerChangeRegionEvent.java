 ...
 */
public class ImplServerChangeRegionEvent extends ImplServerEvent implements ServerChangeRegionEvent {
     ...
     */
    public ImplServerChangeRegionEvent(Server server, Region newRegion, Region oldRegion) {
        super(server);
