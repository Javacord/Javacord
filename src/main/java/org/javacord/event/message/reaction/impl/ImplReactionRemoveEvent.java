 ...
 */
public class ImplReactionRemoveEvent extends ImplSingleReactionEvent implements ReactionRemoveEvent {
     ...
     */
    public ImplReactionRemoveEvent(DiscordApi api, long messageId, TextChannel channel, Emoji emoji, User user) {
