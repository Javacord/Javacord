package de.btobastian.javacord.entity.activity.impl;

import com.fasterxml.jackson.databind.JsonNode;
import de.btobastian.javacord.entity.activity.Activity;
import de.btobastian.javacord.entity.activity.ActivityAssets;
import de.btobastian.javacord.entity.activity.ActivityParty;
...
public class ImplActivity implements Activity {
     ...
     */
    public ImplActivity(JsonNode data) {
        ...
        this.party = data.has("party") ? new ImplActivityParty(data.get("party")) : null;
        this.assets = data.has("assets") ? new ImplActivityAssets(this, data.get("assets")) : null;
