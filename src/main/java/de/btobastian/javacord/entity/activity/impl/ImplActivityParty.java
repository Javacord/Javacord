 ...
 */
public class ImplActivityParty implements ActivityParty {
     ...
     */
    public ImplActivityParty(JsonNode data) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ImplActivityParty)) {
            return false;
        }
        ImplActivityParty otherParty = (ImplActivityParty) obj;
