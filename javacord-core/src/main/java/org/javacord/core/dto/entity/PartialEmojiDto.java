...
public class PartialEmojiDto {
    ...
    @JsonCreator
    public PartialEmojiDto(@Nullable String id, @Nullable String name, @Nullable String roleIds, @Nullable UserDto user, @Nullable Boolean requireColons, @Nullable Boolean managed, @Nullable Boolean animated, @Nullable Boolean available) {
        this.id = id;
        this.name = name;
