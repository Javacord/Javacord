...
public class ImplRole implements Role {
    ...
    public Future<Void> update(String name, Color color, boolean hoist, Permissions permissions, boolean managed, boolean mentionable) {
        ...
        return update(name, color.getRGB(), hoist, ((ImplPermissions) permissions).getAllowed(), managed, mentionable);
    }
     ...
     * @return A future.
     */
    private Future<Void> update(final String name, final int color, final boolean hoist, final int allow, final boolean managed,final boolean mentionable) {
